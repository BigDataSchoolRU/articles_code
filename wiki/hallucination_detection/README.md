...
| Файл | Что делает |
|---|---|
| `hhem_scoring_demo.py` | скоринг четырёх пар (источник, сгенерированный текст) моделью HHEM-2.1-Open — две точные, две с явной галлюцинацией, одна точная, но перефразированная |
